          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-muted-foreground text-lg mb-4">
                Como coletamos, usamos e protegemos seus dados pessoais de
                acordo com a LGPD
              </p>
          ...
          <main className="min-w-0 flex-1">
            ...
            >
              <p className="mb-4 leading-relaxed">
                A <strong>FIRST Personal Banker Empresarial</strong> (CNPJ:
                [XX.XXX.XXX/XXXX-XX]), com sede na [Endereço Completo], é a
                empresa responsável pelo controle dos seus dados pessoais.
              </p>
              <div className="bg-card p-4 rounded-lg border border-border/60">
                <h4 className="font-semibold mb-2">Dados para Contato:</h4>
                <ul className="space-y-1 text-sm">
                  <li>
                    <strong>E-mail:</strong> contato@first-pb.com.br
                  </li>
                  <li>
            ...
            >
              ...
              <LegalCallout type="info">
                <strong>Gerencie suas preferências:</strong> Você pode gerenciar
                suas preferências de cookies a qualquer momento através do nosso{" "}
            ...
            >
              <p className="leading-relaxed">
                Alguns de nossos prestadores de serviços podem estar localizados
                fora do Brasil. Nestes casos, garantimos que sejam aplicadas
            ...
            >
              ...
              <p className="mt-4 leading-relaxed">
                ...
                consentimento parental, tomaremos medidas imediatas para deletar
                essas informações.
              </p>
            </LegalSection>
            ...
            <LegalSection id="alteracoes" title="Alterações nesta Política">
              <p className="leading-relaxed">
                ...
                sobre mudanças significativas através de nossos canais de
                comunicação habituais e atualizaremos a data de "última
                modificação" no topo desta página.
              </p>
            </LegalSection>
              ...
              <div className="bg-card p-6 rounded-lg border border-border/60">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium">dpo@first-pb.com.br</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground mb-2">
                      Prazo de Resposta
              ...
              <Accordion type="single" collapsible>
                <AccordionItem value="faq-1">
                  ...
                  <AccordionContent>
                    ...
                    contato através do e-mail dpo@first-pb.com.br. Processaremos
                    sua solicitação em até 15 dias úteis.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="faq-3">
                  ...
                  <AccordionContent>
                    ...
                    configurações do seu navegador ou usando nossa ferramenta de
                ...
                <AccordionItem value="faq-4">
                  ...
                  <AccordionContent>
                    ...
                    finalidade. Consulte a seção "Retenção e Descarte" para mais
                    detalhes.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            ...
            <footer className="mt-8 pt-6 border-t border-border/60">
              <div className="flex flex-wrap gap-4 justify-center text-sm text-muted-foreground">
                ...
                <span>•</span>
                <a
                  href="mailto:dpo@first-pb.com.br"
